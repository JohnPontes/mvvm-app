...
//  PrimeiroAppMVVM
//
//  Created by John Pontes on 01/01/23.
//
...
class HomeService {
    ...
    func getHomeDataURLSession(completion: @escaping (HomeData?, Error?) -> Void) {
        let urlString: String = "https://run.mocky.io/v3/337b3027-c06f-4ef3-b605-751157583f3b"
    ...
    func getHomeDataAlamofire(completion: @escaping (HomeData?, Error?) -> Void) {
        let url: String = "https://run.mocky.io/v3/337b3027-c06f-4ef3-b605-751157583f3b"
